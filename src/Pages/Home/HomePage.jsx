  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.section}>
        <div
          className={`${styles.sectionHeader} ${
            activeSection === "banner" ? styles.active : ""
          }`}
      ...
      <div className={styles.section}>
        <div
          className={`${styles.sectionHeader} ${
            activeSection === "about-us" ? styles.active : ""
          }`}
      ...
      <div className={styles.section}>
        <div
          className={`${styles.sectionHeader} ${
            activeSection === "why-choose-us" ? styles.active : ""
          }`}
      ...
      <div className={styles.section}>
        <div
          className={`${styles.sectionHeader} ${
            activeSection === "testimonial" ? styles.active : ""
          }`}
